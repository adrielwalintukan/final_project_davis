...
const AIAnalyst: React.FC = () => {
  ...
  return (
    <aside className="w-[272px] min-w-[272px] bg-[#14141f] border-l border-purple-900/20 flex flex-col overflow-hidden">
      {/* Header */}
      ...
      {/* Probes */}
      <div className="px-3.5 py-3 border-t border-purple-900/20">
      ...
      {/* Input */}
      <div className="px-3.5 pb-3.5 flex items-center gap-2 border-t border-purple-900/20 pt-3">
        <input
